     ...
     <Helmet>
       ...
       <div className="bredcrum_org">
        <div className="container_banner">
          ...
          <span className="bredcurn_link"><a class="bread-crumb-e" href="https://kuikdose.com">Home</a> / <span class="bread-crumb-e">Shipping & Payment</span></span>
        </div>
      </div>
