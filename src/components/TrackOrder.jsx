...
const TrackOrder = () => {
  ...
  return (
    <>
        ...
        <div className="title_trac">
            <h2>Track Order</h2>
          </div>
        <div className="input_trackflex">
        <div className="input_tra">
              <label htmlFor="">Order ID</label>
              <input onChange={(e)=>setOrderId(e.target.value)} className="billing_input" placeholder="Found in your order confirmation email." />
              </div>
              <div className="input_tra">
              <label htmlFor="">Billing Email</label>
              <input  onChange={(e)=>setEmail(e.target.value)} className="billing_input" placeholder="Email you used during checkout" />
              </div>
              </div>
