...
const Guarantee = () => {
  ...
  return (
    ...
    <div className="bredcrum_org">
        <div className="container_banner">
          ...
          <span className="bredcurn_link"><a class="bread-crumb-e" href="https://kuikdose.com">Home</a> / <span class="bread-crumb-e">Guarantee</span></span>
        </div>
      </div>
  ...
  <div className="container_banner">
     ...
     <p>Please allow 30 business days from the day your product was sent before contacting us. If you have not received your package after 30 days, or if you have received any information that your package has been placed on hold or returned to sender, please email us at support@kuikdose.com and we will take care of it.</p>
  </div>
  </div>
    </>
  );
