...
import logo_c from "../assets/logo_color-1.svg";
...
const InnerHeader = () => {
  ...
  return (
    <>
      ...
      <div class="arrow-text inner_col">
      <div className="storeopenaa inner_col">
    ...
    <div className="navbar">
      <div className="logo">
      <Link to="/" className="logo_d">  <img src={logo_c} alt="" /></Link>
      <Link to="/" className="mobile_l"><img src={logo} alt="sds" /></Link>
      </div>
      <div className="menu">
           <h1 onClick={()=>setShow(!show)}><img src={menu} /></h1>
        </div>
      <div className="nav_link">
       ...
       <ul className={!show?"not_show":"show_show"}>
          ...
          <li><Link to="/shipping-payment">Shipping & Payment</Link></li>
          <li><Link to="/blogs">Blogs</Link></li>
          <li><Link to="/suggest-a-product">Suggest A Product</Link></li>
          <li><Link to="/contact-us">Contact Us</Link></li>
          {!user?.role?<li><Link to="/login">Login / Register</Link></li>:
          <li className="dropdown">
